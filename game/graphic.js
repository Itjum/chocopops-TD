function init()
{
    ...
    player1 = new Player("player1", 0xffff00, new THREE.Vector2(0, 50), 0);
    scene.add(player1.graphic);

    enemy = new Player("enemy", 0xff0000, new THREE.Vector2(0, 0), 600);
...
function Ground(color, size_x, size_y, nb_tile)
{
    ...
    for (x = minX; x <= maxX; x = x+sizeOfTileX){
        for (y = minY; y <= maxY; y = y+sizeOfTileY){
            ...
            // Spawn tile under enemy and player
            if ((x == 0 && y == 40) || (x == 0 && y == 0)) {
